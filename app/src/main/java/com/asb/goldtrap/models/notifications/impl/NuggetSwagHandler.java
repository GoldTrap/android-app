 ...
 */
public class NuggetSwagHandler extends AbstractSwagHandler {
    @Override
    public void handleSwag(Context context, String value) {
        SwagModel swagModel = new SwagModelImpl(context);
        swagModel.addGoodieCount(GoodiesState.TWO_K, Integer.valueOf(value));
        String qtyString = context.getResources()
                .getQuantityString(R.plurals.take_gold_nuggets,
